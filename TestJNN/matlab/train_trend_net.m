function net = train_trend_net(fts, rsi, ema5, ema10, ema15, ema20, macdline, nineperma)
...
for i=1:test_num
    P(:,i) = [fts(begin_idx+i); fts(begin_idx);fts(begin_idx+i-1); ...
        fts(begin_idx+i-2);fts(begin_idx+i-3); rsi(begin_idx+i); ema5(begin_idx+i); ...
